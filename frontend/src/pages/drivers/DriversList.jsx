    ...
    const header = (
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 dark:bg-black transition-colors duration-300">
            <div className="relative w-full md:w-80">
                ...
                <InputText
                    className="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-zinc-900 border-none rounded-lg text-sm focus:ring-1 focus:ring-black dark:focus:ring-white outline-none transition-all placeholder:text-gray-400 dark:text-white"
